  ...
  getPoke(){
    ...
    this.ps.getPokemonFromApi().subscribe(
      ...
      (data:any) => {
        ...
        if(data.body.types[0].type.name == "normal" || data.body.types[0].type.name == "electric" || 
        data.body.types[0].type.name == "dark" || data.body.types[0].type.name == "steel"  ){
        ...
        if(data.body.types[1].type.name == "normal" || data.body.types[1].type.name == "electric" || 
        data.body.types[1].type.name == "dark" || data.body.types[1].type.name == "steel" ){
